...
{
	Vector3d	broadcast_1			= Vector3d::Zero();
	Vector3d	broadcast_2			= Vector3d::Zero();
	Vector3d	broadcastVel_1		= Vector3d::Zero();
	Vector3d	broadcastVel_2		= Vector3d::Zero();
	Vector3d	precise_1			= Vector3d::Zero();
	Vector3d	precise_2			= Vector3d::Zero();
	bool    	isBroadcastSet_1	= false;
	bool    	isBroadcastSet_2	= false;
	bool    	isPreciseSet_1		= false;
	bool    	isPreciseSet_2		= false;
	bool		canExport			= false;
};	
