...
! ----------------------------------------------------------------------
      ...
      INTEGER :: hr, minute, J_flag, hdiff
      DOUBLE PRECISION sec, DJM0, FD, mjd_i, mjd_j, diff
...
! MJD of original Epoch (including fraction of the day)
    ...
    yml_orbit_arc_determination = yml_orbit_arc_determination - hdiff
    yml_determination_arc_corrected = .true.
    orb_est_arc = orb_est_arc - diff * 86400D0 ! it might not be a full hour ...
