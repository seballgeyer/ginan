...
! Data
         ...
         if (char1 == 'MJD') then
            ...
            do erp_i = 1 , 2
               ...
               igu_erp (erp_i,EOP_X_ERR) = Xsig * 1.0D-6 ! conversion to arcsec
               igu_erp (erp_i,EOP_Y_ERR) = Ysig * 1.0D-6 ! conversion to arc sec
               igu_erp (erp_i,EOP_UT1_ERR) = UTsig * 1.0D-7 ! conversion to seconds
               igu_erp (erp_i,EOP_LOD_ERR) = LODsig * 1.0D-7 ! conversion to seconds
            end do
         end if
! ----------------------------------------------------------------------
      END DO
