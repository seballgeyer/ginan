...
struct OutputOptions
{
	...
	bool	output_downloaded_rtcm_json		= false;
	string 	downloaded_rtcm_json_directory	= "./";
	string	downloaded_rtcm_json_filename	= "<CONFIG>_<WWWW>_<D>_downloaded_rtcm.json";

	bool	output_uploaded_rtcm_json		= false;
	string 	uploaded_rtcm_json_directory	= "./";
	string	uploaded_rtcm_json_filename		= "<CONFIG>_<WWWW>_<D>_uploaded_rtcm.json";
};
